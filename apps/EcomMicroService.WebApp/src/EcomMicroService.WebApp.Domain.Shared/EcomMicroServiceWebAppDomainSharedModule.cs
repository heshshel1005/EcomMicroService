...
namespace EcomMicroService.WebApp;
...
public class EcomMicroServiceWebAppDomainSharedModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        Configure<AbpVirtualFileSystemOptions>(options =>
        {
            options.FileSets.AddEmbedded<EcomMicroServiceWebAppDomainSharedModule>();
        });
