...
using EcomMicroService.WebApp.Blazor.Client.Menus;
...
[DependsOn(typeof(EcomMicroServiceWebAppDomainSharedModule))]
...
public class WebAppBlazorClientModule : AbpModule
{
    ...
    private static void ConfigureAuthentication(WebAssemblyHostBuilder builder)
    {
        builder.Services.AddOidcAuthentication(options =>
        {
            ...
            options.ProviderOptions.DefaultScopes.Add(EcomMicroServiceNames.AdministrationApi);
            options.ProviderOptions.DefaultScopes.Add(EcomMicroServiceNames.IdentityServiceApi);
            options.ProviderOptions.DefaultScopes.Add(EcomMicroServiceNames.SaaSApi);
            options.ProviderOptions.DefaultScopes.Add(EcomMicroServiceNames.WebAppApi);
        });
    }
