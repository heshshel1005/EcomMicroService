...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        try
        {
            Log.Information("Starting EcomMicroService.AuthServer.");
            ...
            await builder.AddApplicationAsync<EcomMicroServiceAuthServerModule>();
        ...
        {
            Log.Fatal(ex, "EcomMicroService.AuthServer terminated unexpectedly!");
            return 1;
        }
        finally
        {
