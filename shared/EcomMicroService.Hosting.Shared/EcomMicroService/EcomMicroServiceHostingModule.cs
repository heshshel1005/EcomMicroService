...
public class EcomMicroServiceHostingModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            var cstr = configuration.GetConnectionString(EcomMicroServiceNames.RabbitMq);
    ...
    )
    {
        context.Services.AddSingleton<IDistributedLockProvider>(sp =>
        {
            var connection = ConnectionMultiplexer.Connect(
                configuration.GetConnectionString(EcomMicroServiceNames.Redis)!
            );
...
public static class HostingExtensions
{
    ...
    )
    {
        var dataProtectionBuilder = context
            ...
            .SetApplicationName(EcomMicroServiceNames.EcomMicroService);
