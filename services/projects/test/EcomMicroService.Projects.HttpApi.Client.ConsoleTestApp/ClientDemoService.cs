...
using EcomMicroService.Projects.Samples;
using Volo.Abp.DependencyInjection;
using Volo.Abp.IdentityModel;

namespace EcomMicroService.Projects.HttpApi.Client.ConsoleTestApp;
...
) : ITransientDependency
{
    ...
    private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
    {
        ...
        using (var httpClient = new HttpClient())
        {
            ...
            var url =
                _configuration["RemoteServices:Projects:BaseUrl"]
